                ...
                children: [
                  FittedBox(
                    ...
                    ListTile(
                      ...
                      title: Text('查看本周课表、切换学年，请点击这里',style: TextStyle(fontWeight: FontWeight.bold,fontSize: GlobalVars.homecoursetable_morehint_title),),
                      onTap: (){Navigator.push(context, MaterialPageRoute(builder: (BuildContext ctx) => CourseTablePage()));},
                    ),
                  ],
                ),
              ),
